...
message.channel.send(embed)
  ...
  message.channel.send(new Discord.MessageEmbed().setColor("RANDOM").setDescription("<a:warn:826764171261640735> Kullanıcıyı Bulamadım!"));
  return;
}
